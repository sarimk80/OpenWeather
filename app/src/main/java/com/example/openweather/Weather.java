...
import com.example.openweather.view_model.WeatherViewModel;
...
public class Weather extends Fragment {
    ...
    private void getData() {
        ...
        WeatherViewModel weatherViewModel = ViewModelProviders.of(Weather.this).get(WeatherViewModel.class);

        weatherViewModel.getViewModel(Latitude, Longitude, "b6907d289e10d714a6e88b30761fae22").observe(Weather.this, weatherModel -> {
